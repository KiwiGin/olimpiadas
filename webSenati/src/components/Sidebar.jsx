    ...
    <>
        <div className='ml-1/5 min-w-60 h-full bg-amber-200 overflow-auto'>
            ...
            <div className='flex flex-col items-center justify-center h-2/7 mb-10'>
                <Link to="/home">
                    <div className='w-24 h-24 mt-2 flex flex-col items-center justify-center hover:bg-slate-100 rounded-full'>
            ...
            <div className='h-5/7 overflow-auto '>
                <Link to="/home">
                    <div className='flex flex-col items-center justify-center h-16 group/item hover:bg-slate-100 rounded-full'>
                ...
                <Link to="/home/miperfil">
                    <div className='flex flex-col items-center justify-center h-16 mb-96 group/item hover:bg-slate-100 rounded-full'>
                        <h1 className='text-2xl font-bold'>Perfil</h1>
                    </div>
                </Link>
                <div className='flex flex-col items-center justify-center h-16 group/item hover:bg-slate-100 rounded-full cursor-pointer' onClick={handleClick}>
